...
#define SYS_FREQ		(16000000)		//16 hz == 16,000,000 cycles
#define APB1_CLK		SYS_FREQ		//set system frequency to clock
#define UART_BAUDRATE	115200			//bd
